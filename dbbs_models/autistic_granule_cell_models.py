...
class AutisticGranuleCell(DbbsNeuronModel):
        v1 = 1.8  #soma, mechanisms, Kv4_3, gkbar = 1.8
        v2 = 1.8  #dendrites, mechanisms, Kca1_1, gbar = 1.8
        v3= 1.9  #AIS, mechanisms, Na, granule_cell_FHF, gnabar = 1.9
        v4 = 1.81  #AIS, mechanisms, Kv3_4, gkbar = 1.81
        v5 = 2.5   #synapse_types, NMDA gmax = 2.5
        morphologies = ["GranuleCell.swc"]
        synapse_types = {
            "AMPA": {
                "point_process": ("AMPA", "autistic"),
                "attributes": {
                    "tau_facil": 5,
                    "tau_rec": 8,
                    "tau_1": 1,
        ...
        section_types = {
            "soma": {
                ...
                "mechanisms": {
                    ...
                    "Kv4_3": {"gkbar": 0.00281496839061*v1}, ########
            ...
            "dendrites": {
                ...
                "mechanisms": {
                    ...
                    "Kca1_1": {"gbar": 0.01001807454651*v2}, #######
            ...
            "axon_initial_segment": compose_types(
                "ascending_axon",
                {
                    ...
                    "ions": {"na": {"e": 87.39}, "k": {"e": -80.993}, "ca": {"e": 137.5}},
                    "mechanisms": {
                        ("Na", "granule_cell_FHF"): {"gnabar": 1.28725006737226*v3}, ######
                        "Kv3_4": {"gkbar": 0.00649595340654*v4}, #######
